...
export default async function Projects() {
  ...
  return (
    <div className='space-y-6 text-center'>
      <h2>Projects</h2>
      <div className='group/item space-y-3 md:flex md:flex-wrap md:gap-x-2 md:space-y-0'>
        {projects?.map((project: any) => (
          <Link href={project.projectUrl || ''} target='__blank' key={project.title} className='text-left shadow-lg md:flex-1'>
